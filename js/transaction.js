$(document).ready(function () {
  ...
  $.ajax({
    ...
    success: function (txn) {
      ...
      $('#transactionFee').text(numeral(txn.tx.fee / Math.pow(10, ExplorerConfig.decimalPoints)).format('0,0.0000000') + ' ' + ExplorerConfig.ticker)
      ...
      $('#transactionAmount').text(numeral(txn.tx.amount_out / Math.pow(10, ExplorerConfig.decimalPoints)).format('0,0.0000000') + ' ' + ExplorerConfig.ticker)
      ...
      const inputs = $('#inputs').DataTable({
        columnDefs: [{
          ...
          render: function (data, type, row, meta) {
            if (type === 'display') {
              data = numeral(data / Math.pow(10, ExplorerConfig.decimalPoints)).format('0,0.0000000')
            }
            return data
          },
          searchable: false
...
function checkTransaction() {
  ...
  $('#ourAmount').text(': Found ' + numeral(totalOwned / Math.pow(10, ExplorerConfig.decimalPoints)).format('0,0.0000000') + ' ' + ExplorerConfig.ticker)
}
