$(document).ready(function () {
  ...
  $.ajax({
    ...
    success: function (txn) {
      ...
      $('#transactionFee').text(numeral(txn.tx.fee / Math.pow(10, ExplorerConfig.decimalPoints)).format('0,0.000000') + ' ' + ExplorerConfig.ticker)
      ...
      $('#transactionAmount').text(numeral(txn.tx.amount_out / Math.pow(10, ExplorerConfig.decimalPoints)).format('0,0.000000') + ' ' + ExplorerConfig.ticker)
...
function checkTransaction() {
  ...
  $('#ourAmount').text(': Found ' + numeral(totalOwned / Math.pow(10, ExplorerConfig.decimalPoints)).format('0,0.000000') + ' ' + ExplorerConfig.ticker)
}
